...
from modules import Attension


class AttenPredictor(BasePredictor):#also call basepredictor function
    """
    Args:
    ...
    def __init__(self, embedding,
        ...
        super(AttenPredictor, self).__init__(**kwargs)
        self.model = Attension(embedding.size(1),
        ...
        #self.optimizer = torch.optim.SGD(self.model.parameters(),lr=0.2,momentum=0.9)
